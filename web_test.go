...
// 	b, _, err := GetPage(context.Background(), "https://explainshell.com/explain", "cut -f1 -d: /etc/passwd")
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// 	// filename := "example_" + fmt.Sprint(i) + ".html"
// 	filename := "example_5.html"
